...
public class KafkaConsumerConfig {
    ...
    public KafkaConsumerConfig(KafkaProperties kafkaProperties) { this.kafkaProperties = kafkaProperties;}
    ...
    ConcurrentKafkaListenerContainerFactory<String, UserResponse> listenerContainerFactory(
            @Qualifier("consumerFactory")ConsumerFactory<String, UserResponse> consumerFactory){
        log.info("Criando: listenerContainerFactory");
